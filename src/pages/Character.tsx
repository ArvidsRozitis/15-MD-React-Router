...
import { ballColorStyle } from "../modules/ballColorStyle";
      ...
      <div className={style.informationWrapper}>
        <div className={style.textWrapper}>
          ...
          <div className={style.status}>
            <div className={ballColorStyle(data.status)}></div>
        ...
        <div className={style.textWrapper}>
          <span className={style.helperText}>Last known location</span>
          <h3 className={style.h3}>{data.location.name}</h3>
        </div>
        <div className={style.textWrapper}>
          <span className={style.helperText}>First seen in episode</span>
          <h3 className={style.h3}>{data.episode[0]}</h3>
        </div>
      </div>
    </div>
  );
